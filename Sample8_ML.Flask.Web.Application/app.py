...
@app.route('/')
def home_page():
    return render_template('welcome.html', message='**Please fill out all fields**')
...
def result():
    ...
    if request.method == 'POST':
        ...
        if boole:
            ...
            return render_template('model.html', prediction=prediction, message='**Please fill out all fields**')
